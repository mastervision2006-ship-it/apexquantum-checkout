      ...
      <div className="checkout-wrap" style={{ position: "relative", zIndex: 1, maxWidth: "1100px", margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <h1 style={{
            ...
            color: "var(--text-base)", lineHeight: 1.1, marginBottom: "0.75rem",
          }}>
        ...
        <div className="plans-grid" style={{
          ...
          {PLANS.map((plan) => {
            ...
            const discountedNum = Math.max(0, plan.priceNum - appliedDiscount);
            const showDiscount = appliedDiscount > 0;
            return (
              <div
                key={plan.id}
              ...
              >
                ...
                <div style={{
                  ...
                  color: "var(--text-soft)", letterSpacing: "0.05em",
                ...
                <div style={{ marginBottom: "0.25rem", lineHeight: 1 }}>
                  ...
                  <span style={{
                    ...
                    color: showDiscount ? "#4ade80" : (isSelected ? "var(--gold-bright)" : "var(--text-base)"),
                    transition: "color 0.3s ease", letterSpacing: "-0.02em",
                  }}>
                    {showDiscount ? formatPrice(discountedNum) : plan.price}
                  </span>
                </div>
                <div style={{
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: "0 0 1.75rem" }}>
                  {plan.features.map((f, i) => (
                    <li key={i} style={{
                      ...
                      padding: "5px 0",
                      fontFamily: "var(--font-ui)", fontSize: "0.82rem",
                      color: "var(--text-soft)", lineHeight: 1.55,
                    }}>
        ...
        <div ref={formRef} className="form-card" style={{
          ...
          {step === 1 ? (
            <>
              ...
              <div style={{
                ...
                <div style={{ textAlign: "right" }}>
                  {hasDiscount && (
                    <div style={{ fontFamily: "var(--font-ui)", fontSize: "0.78rem", color: "var(--text-dim)", textDecoration: "line-through", lineHeight: 1 }}>
                      R$ {currentPlan.price}
                    </div>
                  )}
                  <div style={{ fontFamily: "var(--font-price)", fontSize: "1.6rem", fontWeight: 800, color: hasDiscount ? "#4ade80" : "var(--text-base)", lineHeight: 1, letterSpacing: "-0.02em" }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              {/* Preço com desconto no step 2 */}
              {hasDiscount && (
                <div style={{ fontFamily: "var(--font-ui)", fontSize: "0.85rem", color: "var(--text-dim)", textDecoration: "line-through", marginBottom: "2px" }}>
                  R$ {currentPlan.price}
                </div>
              )}
              <div style={{
                ...
                color: hasDiscount ? "#4ade80" : "var(--gold-bright)",
              ...
              {hasDiscount && (
                <div style={{
                  ...
                  fontFamily: "var(--font-ui)", fontSize: "0.75rem", fontWeight: 600, color: "#4ade80",
                  marginBottom: "0.5rem",
                }}>
                  Desconto de R$ {formatPrice(appliedDiscount)} aplicado
                </div>
              )}
              ...
              {/* Notice */}
              <div style={{
                background: "rgba(196,154,56,0.06)", border: "1px solid rgba(196,154,56,0.15)",
                ...
                <p style={{ fontFamily: "var(--font-ui)", fontSize: "0.82rem", color: "var(--gold)", lineHeight: 1.6, margin: 0 }}>
                  ...
                  {hasDiscount && (
                    <><br /><span style={{ color: "#4ade80" }}>🏷️ Informe o cupom de desconto ao enviar o comprovante.</span></>
                  )}
                </p>
              </div>
